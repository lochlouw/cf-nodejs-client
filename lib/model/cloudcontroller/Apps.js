...
class Apps extends CloudControllerBase {
    ...
    */
    ...
    /**
     * Copy source from one app to another
     * {@link http://apidocs.cloudfoundry.org/214/apps/copy_the_app_bits_for_an_app.html}
     *
     * @param  {String} appGuid     [App guid]
     * @param  {JSON} appOptions   [options to create the application]
     * @return {JSON}              [information about the application]
     */
    copyBits (appGuid, appOptions) {

        const url = `${this.API_URL}/v2/apps/${appGuid}/copy_bits`;
        const options = {
            method: "POST",
            url: url,
            headers: {
